...
public class Get_recomend_item_shoese extends AsyncTask<String,Void, Codenate_path_list>{
    ...
    protected Codenate_path_list doInBackground(String... userNos) {
        ...
        //POST先のURL
        String GetURL = "http://"+ AWS_INTERFACE.IPADDRESS +"/tanuki/get_recomend_web_item_shoese?UserNo="+userNo;
        //接続するためのクラスを宣言
        int rescode = -1;
        String result = "";
        try {
